...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-11 px-4 text-left align-middle text-[11px] font-semibold tracking-[0.08em] uppercase whitespace-nowrap text-muted-foreground",
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "px-4 py-3.5 align-middle text-sm leading-relaxed",
        "[&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className,
      )}
      {...props}
